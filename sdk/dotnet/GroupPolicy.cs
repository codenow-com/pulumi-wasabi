...
{
    [WasabiResourceType("wasabi:index/groupPolicy:GroupPolicy")]
    public partial class GroupPolicy : global::Pulumi.CustomResource
    {
        ...
        public GroupPolicy(string name, GroupPolicyArgs args, CustomResourceOptions? options = null)
            : base("wasabi:index/groupPolicy:GroupPolicy", name, args ?? new GroupPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private GroupPolicy(string name, Input<string> id, GroupPolicyState? state = null, CustomResourceOptions? options = null)
            : base("wasabi:index/groupPolicy:GroupPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
