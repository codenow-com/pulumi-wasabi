...
{
    [WasabiResourceType("wasabi:index/bucketPublicAccessBlock:BucketPublicAccessBlock")]
    public partial class BucketPublicAccessBlock : global::Pulumi.CustomResource
    {
        ...
        public BucketPublicAccessBlock(string name, BucketPublicAccessBlockArgs args, CustomResourceOptions? options = null)
            : base("wasabi:index/bucketPublicAccessBlock:BucketPublicAccessBlock", name, args ?? new BucketPublicAccessBlockArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private BucketPublicAccessBlock(string name, Input<string> id, BucketPublicAccessBlockState? state = null, CustomResourceOptions? options = null)
            : base("wasabi:index/bucketPublicAccessBlock:BucketPublicAccessBlock", name, state, MakeResourceOptions(options, id))
        {
        }
