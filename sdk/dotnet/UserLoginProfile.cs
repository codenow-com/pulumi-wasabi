...
{
    [WasabiResourceType("wasabi:index/userLoginProfile:UserLoginProfile")]
    public partial class UserLoginProfile : global::Pulumi.CustomResource
    {
        ...
        public UserLoginProfile(string name, UserLoginProfileArgs args, CustomResourceOptions? options = null)
            : base("wasabi:index/userLoginProfile:UserLoginProfile", name, args ?? new UserLoginProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserLoginProfile(string name, Input<string> id, UserLoginProfileState? state = null, CustomResourceOptions? options = null)
            : base("wasabi:index/userLoginProfile:UserLoginProfile", name, state, MakeResourceOptions(options, id))
        {
        }
