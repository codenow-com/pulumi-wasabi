...
{
    [WasabiResourceType("wasabi:index/groupPolicyAttachment:GroupPolicyAttachment")]
    public partial class GroupPolicyAttachment : global::Pulumi.CustomResource
    {
        ...
        public GroupPolicyAttachment(string name, GroupPolicyAttachmentArgs args, CustomResourceOptions? options = null)
            : base("wasabi:index/groupPolicyAttachment:GroupPolicyAttachment", name, args ?? new GroupPolicyAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private GroupPolicyAttachment(string name, Input<string> id, GroupPolicyAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("wasabi:index/groupPolicyAttachment:GroupPolicyAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
