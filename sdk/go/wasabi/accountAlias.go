...
func NewAccountAlias(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("wasabi:index/accountAlias:AccountAlias", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccountAlias(ctx *pulumi.Context,
	...
	var resource AccountAlias
	err := ctx.ReadResource("wasabi:index/accountAlias:AccountAlias", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
