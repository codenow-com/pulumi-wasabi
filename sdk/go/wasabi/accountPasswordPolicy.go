...
func NewAccountPasswordPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("wasabi:index/accountPasswordPolicy:AccountPasswordPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccountPasswordPolicy(ctx *pulumi.Context,
	...
	var resource AccountPasswordPolicy
	err := ctx.ReadResource("wasabi:index/accountPasswordPolicy:AccountPasswordPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
