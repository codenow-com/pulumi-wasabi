...
func NewGroupPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("wasabi:index/groupPolicy:GroupPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGroupPolicy(ctx *pulumi.Context,
	...
	var resource GroupPolicy
	err := ctx.ReadResource("wasabi:index/groupPolicy:GroupPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
