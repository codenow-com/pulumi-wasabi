...
func NewUserGroupMembership(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("wasabi:index/userGroupMembership:UserGroupMembership", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserGroupMembership(ctx *pulumi.Context,
	...
	var resource UserGroupMembership
	err := ctx.ReadResource("wasabi:index/userGroupMembership:UserGroupMembership", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
