...
func NewBucketPublicAccessBlock(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("wasabi:index/bucketPublicAccessBlock:BucketPublicAccessBlock", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBucketPublicAccessBlock(ctx *pulumi.Context,
	...
	var resource BucketPublicAccessBlock
	err := ctx.ReadResource("wasabi:index/bucketPublicAccessBlock:BucketPublicAccessBlock", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
