...
func NewPolicyAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("wasabi:index/policyAttachment:PolicyAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyAttachment(ctx *pulumi.Context,
	...
	var resource PolicyAttachment
	err := ctx.ReadResource("wasabi:index/policyAttachment:PolicyAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
