...
func NewUserPolicyAttachment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("wasabi:index/userPolicyAttachment:UserPolicyAttachment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserPolicyAttachment(ctx *pulumi.Context,
	...
	var resource UserPolicyAttachment
	err := ctx.ReadResource("wasabi:index/userPolicyAttachment:UserPolicyAttachment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
