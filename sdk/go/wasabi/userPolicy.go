...
func NewUserPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("wasabi:index/userPolicy:UserPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserPolicy(ctx *pulumi.Context,
	...
	var resource UserPolicy
	err := ctx.ReadResource("wasabi:index/userPolicy:UserPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
