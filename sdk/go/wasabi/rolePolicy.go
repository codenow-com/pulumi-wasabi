...
func NewRolePolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("wasabi:index/rolePolicy:RolePolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRolePolicy(ctx *pulumi.Context,
	...
	var resource RolePolicy
	err := ctx.ReadResource("wasabi:index/rolePolicy:RolePolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
