...
func NewUserLoginProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("wasabi:index/userLoginProfile:UserLoginProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserLoginProfile(ctx *pulumi.Context,
	...
	var resource UserLoginProfile
	err := ctx.ReadResource("wasabi:index/userLoginProfile:UserLoginProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o UserLoginProfileOutput) PgpKey() pulumi.StringOutput {
	return o.ApplyT(func(v *UserLoginProfile) pulumi.StringOutput { return v.PgpKey }).(pulumi.StringOutput)
}
